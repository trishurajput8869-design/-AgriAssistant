function Hero() {
  return (
    <section
      id="home"
      className="min-h-screen bg-black text-white flex items-center justify-center px-5 relative overflow-hidden"
    >
      {/* Background Glow */}
      ...
      <div className="text-center max-w-4xl relative z-10">
        ...
        <div className="flex justify-center gap-5 flex-wrap">
          <button className="bg-gradient-to-r from-green-500 to-emerald-600 px-8 py-3 rounded-xl text-lg font-semibold shadow-lg shadow-green-500/30 hover:scale-105 transition-all duration-300">
            🌿 Start AI Chat
          </button>

          <button className="border-2 border-green-500 text-green-400 px-8 py-3 rounded-xl text-lg font-semibold hover:bg-green-500 hover:text-white hover:scale-105 transition-all duration-300">
            📷 Detect Disease
          </button>
        </div>
        ...
        <div className="mt-12 grid grid-cols-3 gap-5 text-center">
          ...
          <div>
            ...
            <p className="text-gray-400">Assistance</p>
          </div>

          <div>
            <h3 className="text-3xl font-bold text-green-400">Smart</h3>
            <p className="text-gray-400">Farming</p>
          </div>
        </div>
      </div>
    </section>
