        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={feature.number}
                className="group relative bg-white rounded-[28px] border border-green-100 overflow-hidden shadow-[0_10px_35px_rgba(20,83,45,0.05)] hover:shadow-[0_20px_55px_rgba(20,83,45,0.11)] hover:-translate-y-1.5 transition-all duration-300"
              >
                ...
                {index === 0 && (
                  <div className="relative h-44 overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-green-950/75 via-green-950/10 to-transparent" />
                    ...
                    <div className="absolute top-4 right-5 text-xs font-extrabold text-white/90">
                      {feature.number}
                    </div>
                ...
                {index !== 0 && (
                  <div className="px-7 pt-7">
                    ...
                    <div className="absolute top-7 right-7 text-xs font-extrabold text-green-200">
                      {feature.number}
                    </div>

                    {/* Icon */}

                    <div className="w-14 h-14 rounded-2xl bg-green-50 border border-green-100 flex items-center justify-center group-hover:bg-green-700 transition-colors duration-300">
                ...
                <div className="p-7 md:p-8">
                  ...
                  {index === 0 && (
                    <div className="w-12 h-12 -mt-1 mb-5 rounded-2xl bg-green-50 border border-green-100 flex items-center justify-center">
